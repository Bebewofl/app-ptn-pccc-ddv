...
cd /d "%~dp0"
title HUB-PTN V2.2.6 Stable-1 - Production Deploy

echo ============================================================
echo HUB-PTN V2.2.6 Stable-1 - SAFE PRODUCTION DEPLOY
echo Source: GitHub release-hub-v2.2.6-stable
echo Target: app-ptn-pccc / https://app-ptn-pccc.web.app
echo Previous stable: HUB V2.2.5 Stable-1
echo ============================================================
echo.
...
set "CI_SHA=469a0f77eb01bf4c792de7778fe83a2e63f941d7"

echo [1/6] Fetching locked V2.2.6 Stable-1 source from GitHub...
git fetch origin release-hub-v2.2.6-stable
if errorlevel 1 goto :fail
for /f "delims=" %%I in ('git rev-parse origin/release-hub-v2.2.6-stable') do set "REL_SHA=%%I"
...
if errorlevel 1 (
  echo ERROR: Stable release differs from the CI-tested source. Stop for safety.
  echo Production unchanged.
  pause
  exit /b 1
)
echo CI guard: OK. Source, Rules and production build already passed GitHub Actions.

set "WORKTREE=%TEMP%\hub-v226-stable-%RANDOM%-%RANDOM%"
...
echo.
echo READY TO DEPLOY HUB V2.2.6 Stable-1 to PRODUCTION.
echo This will replace V2.2.5 Stable-1 Hosting and deploy the CI-tested Firestore Rules.
...
echo.
echo ============================================================
echo DEPLOY SUCCESS - HUB V2.2.6 Stable-1
echo Production: https://app-ptn-pccc.web.app
echo ============================================================
start "" "https://app-ptn-pccc.web.app/?fromDeploy=V226"
goto :cleanup_ok
...
:fail
echo.
echo ERROR: Could not prepare the locked V2.2.6 Stable-1 source. Production unchanged.
pause
exit /b 1
