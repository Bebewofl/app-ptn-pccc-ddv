...
if(info.projectId!=='app-ptn-pccc'||info.environment!=='production'||info.version!=='2.2.5'||info.release!=='Stable-1'){
...
console.log('PRODUCTION DEPLOY OK: HUB V2.2.5 Stable-1');
